...
export default function ExpandableModal({ 
  ...
  const modalContent = (
    ...
    >
      <div
        ref={modalRef}
        className="bg-white rounded-xl shadow-2xl max-w-4xl w-full h-[80vh] overflow-hidden transform transition-all duration-300 ease-out flex flex-col"
        style={{
      ...
      >
        {/* Modal Header */}
        <div className="flex items-center justify-between p-6 border-b border-axiom-border-light bg-axiom-bg-card-white flex-shrink-0">
